        ...
        <div className="mt-2 flex flex-col gap-1">
          ...
          {documents.map((doc) => (
            ...
            >
              ...
              <span className="text-xs text-gray-700 dark:text-gray-300 flex-1 truncate" title={doc.original_name}>
                {doc.original_name}
              </span>
              <button
      ...
      <div className="px-3 py-3 border-t border-gray-200 dark:border-[#222230] flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-medium text-gray-900 dark:text-white truncate">{user?.full_name}</div>
